...
import com.iho.app.Database.DisplayDataFromDB.EventsFragment;
import com.iho.app.Database.DisplayDataFromDB.GalleryFragment;
import com.iho.app.Database.DisplayDataFromDB.LecturerFragment;
import com.iho.app.Database.DisplayDataFromDB.NewsFragment;
import com.iho.app.Database.DisplayDataFromDB.ScienceFragment;
import com.iho.app.Database.DisplayDataFromDB.TravelFragment;
import com.iho.app.Pages.About;
import com.iho.app.Pages.Connect;
import com.iho.app.Pages.Credits;
import com.iho.app.Pages.Donate;
import com.iho.app.Pages.FieldNotes;
import com.iho.app.Pages.Gallery;
import com.iho.app.Pages.Lucy;
import com.iho.app.Pages.MainFragment;
import com.iho.app.Pages.NewsEvents;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.linkToContact:
                uri = Uri.parse("https://iho.app.edu/contact/contact-us");
                intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
                break;
            case R.id.fbButton:
...
//                break;
                ...
                email.putExtra(Intent.EXTRA_EMAIL, new String[]{ "iho@app.edu"});
                email.putExtra(Intent.EXTRA_SUBJECT, "IHO E-News Subscription");
                startActivity(Intent.createChooser(email, "Choose an Email Client:"));
                break;
            case R.id.website:
                uri = Uri.parse("https://iho.app.edu/");
                intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
                break;
...
//                email.setData(Uri.parse("mailto:"));
//                email.setType("text/plain");
//                email.putExtra(Intent.EXTRA_EMAIL, new String[]{ "bbaburaj@app.edu"});
//                email.putExtra(Intent.EXTRA_SUBJECT, "IHO E-News Subscription");
//                startActivity(Intent.createChooser(email, "Choose an Email Client:"));
//                break;
...
//            try {
//                sender.sendMail("E News Subscription"," Please send eNews to "+emailId,emailId, "iho@app.edu");
